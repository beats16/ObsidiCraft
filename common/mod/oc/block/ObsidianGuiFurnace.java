...
public class ObsidianGuiFurnace extends GuiContainer
{
    private TileEntityObsidianFurnace furnaceInventory;

    public ObsidianGuiFurnace(InventoryPlayer par1InventoryPlayer, TileEntityObsidianFurnace par2TileEntityFurnace)
    {
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        this.mc.renderEngine.bindTexture("/mods:obsidianFurnaceGui");
