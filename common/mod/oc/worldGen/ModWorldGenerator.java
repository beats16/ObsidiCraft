...
public class ModWorldGenerator extends WorldGenerator
{
    private int blockID;
    ...
    public ModWorldGenerator(Block block, int meta, int chance)
    {
    ...
    public ModWorldGenerator(int blockID, int meta, int chance, int... target)
    {
