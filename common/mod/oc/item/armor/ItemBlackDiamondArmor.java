...
public class ItemBlackDiamondArmor extends ItemArmor 
{
    ...
    public static Icon func_94602_b(int par0)
    {
        ...
        {
            case 0:
                return ModArmor.blackDiamondHelmet.field_94604_cx;
            case 1:
                return ModArmor.blackDiamondChestPlate.field_94604_cx;
            case 2:
                return ModArmor.blackDiamondLeggings.field_94604_cx;
            case 3:
                return ModArmor.blackDiamondBoots.field_94604_cx;
            default:
                return null;
        }
    }
    ...
    {
        if(itemstack.itemID == ModArmor.blackDiamondBoots.itemID || itemstack.itemID == ModArmor.blackDiamondChestPlate.itemID || itemstack.itemID == ModArmor.blackDiamondHelmet.itemID)
        {
            return "/mods/oc/textures/armor/blackDiamond_1.png";
        }
        
        if(itemstack.itemID == ModArmor.blackDiamondLeggings.itemID )
        {
            return "/mods/oc/textures/armor/blackDiamond_2.png";
        }
        return null;
    }
}
