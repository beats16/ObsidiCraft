...
public class ModItemBow extends Item
{
    public static final String[] bowPullIconNameArray = new String[] {"obsidianBow_pull_0", "obsidianBow_pull_1", "obsidianBow_pull_2"};
    @SideOnly(Side.CLIENT)
    private Icon[] iconArray;

    public ModItemBow(int par1)
    {
        super(par1);
        this.maxStackSize = 1;
    ...
    {
        itemIcon = iconRegister.registerIcon(ReferenceVariables.MOD_ID.toLowerCase() + ":obsidianBow");
